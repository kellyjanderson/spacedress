# SpaceDress name and project identity

The Apache License 2.0 licenses the SpaceDress source and documentation. It does **not** grant trademark rights.

`SpaceDress`, its project logo when one is adopted, and distinctive project branding identify the upstream SpaceDress project.

## Permitted descriptive use

You may accurately say that software:
...
A redistributed modified product should use a distinct product name unless the upstream maintainer has agreed otherwise. The upstream name may still be used factually to identify origin and compatibility.
